...
ApplicationWindow {
    ...
    FontLoader { id: regular; source: "qrc:/Components/fontawesome-free-5.0.10/use-on-desktop/Font Awesome 5 Free-Regular-400.otf" }
    FontLoader { id: solid; source: "qrc:/Components/fontawesome-free-5.0.10/use-on-desktop/Font Awesome 5 Free-Solid-900.otf" }
    FontLoader { id: brand; source: "qrc:/Components/fontawesome-free-5.0.10/use-on-desktop/Font Awesome 5 Brands-Regular-400.otf" }
